import { inspecParams, sku_other } from '../../../services/task.service';
...
import { project, TaskService } from '../../../services/task.service';
import { InspectionService, uploadData } from '../../../services/inspection.service';
...
@Component({
    ...
    providers: [inspectionObjPipe, UploadimgComponent], //组件级别提供器
})
export class InspectionPage implements OnInit, OnDestroy {
    ...
    submit() {
        ...
        this.inspectService.submitData(this.uploadData).subscribe((data: any) => {
            if (data.status == 1) {
                this.canLeave = true;
